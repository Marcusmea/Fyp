...
public class Notification extends AppCompatActivity {
    ...
    public void displayNotificationMaster(){
        ...
        Toast.makeText(Notification.this, "Notification for master room", Toast.LENGTH_SHORT).show();
    ...
    public void displayNotificationBedroom(){
        ...
        Toast.makeText(Notification.this, "Notification for Bed room", Toast.LENGTH_SHORT).show();
